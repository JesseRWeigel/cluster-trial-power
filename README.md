...
Cluster-randomised trial power and sample size calculator with the operating characteristic curve, validated against published reference values

Catalog task: `EDU-039`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
